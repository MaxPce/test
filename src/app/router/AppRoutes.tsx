...
// ← NUEVO: página de detalle de deporte para eventos de Sismaster
    ...
    <Routes>
      ...
      >
        ...
        <Route path="sismaster-events">
          ...
          <Route
            path=":externalEventId/sports"
            element={<EventSportsPage />}
          />
          ...
          {/*
           * Las sub-rutas de categoría se mantienen por si en el futuro
           * navegas a una categoría concreta desde la página de detalle.
           * Por ahora no se usan desde SismasterSportDetailPage.
           */}
          <Route
