import { X, Trophy, Clock, Calendar, MapPin, Swords, Award } from "lucide-react";
...
export const JudoMatchDetailsModal = ({ match, phase, isOpen, onClose }: Props) => {
  const advanceWinnerMutation = useAdvanceWinner();
  const [isJudoModalOpen, setIsJudoModalOpen] = useState(false);
  ...
  const formatScore = (score: any): string => {
    ...
    if (score === 10 || score === "10") return "10";
    const n = parseFloat(score);
    if (isNaN(n)) return String(score);
    return String(Math.floor(n));
  };

  const isIppon = (score: any) =>
    score === 10 || score === "10" || Number(score) === 10;
    ...
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
          ...
          {/* Header */}
          <div className="sticky top-0 bg-gradient-to-r from-blue-700 to-cyan-600 text-white px-6 py-4 flex items-center justify-between z-10 rounded-t-xl">
            ...
            <div className="flex items-center gap-2">
              ...
              {canRegisterScore && (
                <button
                  onClick={() => setIsJudoModalOpen(true)}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-3">
                      ...
                      {isIppon(match.participant1Score) && (
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-3">
                      ...
                      {isIppon(match.participant2Score) && (
              ...
              {!hasScore ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    {isIppon(match.participant1Score) && (
                      <span className="mt-1 inline-block text-xs font-bold text-blue-700 bg-blue-200 px-2 py-0.5 rounded-full">
                        IPPON
                      </span>
                    )}
                  </div>
                  ...
                  >
                    ...
                    {isIppon(match.participant2Score) && (
                      <span className="mt-1 inline-block text-xs font-bold text-red-700 bg-red-200 px-2 py-0.5 rounded-full">
                        IPPON
                      </span>
                    )}
                  </div>
      ...
      {/* Modal de registro de puntaje */}
      {canRegisterScore && (
        <JudoScoreModal
          isOpen={isJudoModalOpen}
          onClose={() => setIsJudoModalOpen(false)}
          match={match}
          phase={phase}
        />
      )}
