...
export function PoomsaeResultsTable({
  ...
  const { data: manualRanks = [] } = useManualRanks(
  ...
  const hasAnyManualRank = manualRanks.some(
    (r) => r.manualRankPosition != null
  );
  ...
  // standings finales: si existe manual_rank lo usa para ordenar, sino usa posición natural
                    ...
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {standings.map((score: any) => {
                          ...
                          const isMedalist =
                            allScoresRegistered && position <= 3;
                                  ...
                                  <div className="flex flex-col items-start gap-0.5">
                                    ...
                                    {score.hasManualOverride && (
                                      <span
                                        ...
                                        className="flex items-center gap-0.5 text-xs text-purple-500 font-medium"
                                      >
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-gray-600">
                      ...
                      {hasAnyManualRank && (
                        <span className="text-purple-600">
                          <strong>✎ manual:</strong> Posición ajustada por el
                          operador
                        </span>
                      )}
                    </div>
